...
**QiaoJi override:** if the current project is QiaoJi, prefer the project preset at `../../references/qiaoji-default-style.md` and skip the onboarding question unless the user explicitly asks to customize the skin further.
...
Use for any of the 14 diagram types (第3章) when a reader will learn more from a visual than from prose, a table, or a bulleted list.
...
- If you're past the complexity budget (第7章), split into an overview + detail.
...
**Type fit:**
- [ ] Right type for what I'm showing? (第3章 selection guide)
...
- [ ] Within the type's complexity budget (第7章)?
