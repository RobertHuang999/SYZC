...
> **moduleId**：`biz-approve-in-loan-risk-sso`
> **菜单路径**：业务办理 → 其他审批 → 贷中风控处理
> **原型路由**：`/m/module/biz-approve-in-loan-risk-sso`
> **PC 原路径**：联登智风控
> **原型标签**：联登智风控
> **功能清单唯一定义来源**：`03-前端原型demo/B端H5/src/data/mobileMenuData.ts`
> **基准路径**：`B端H5/03-业务办理/04-其他审批/03-贷中风控处理`
...
处理全系统触发的二级/三级重大风控警报，支持一键联登智风控决策引擎执行动态熔断与复核。
