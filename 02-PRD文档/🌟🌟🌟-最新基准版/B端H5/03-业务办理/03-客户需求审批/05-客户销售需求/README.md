...
> **moduleId**：`biz-approve-customer-sales-req`
> **菜单路径**：业务办理 → 客户需求审批 → 客户销售需求
> **原型路由**：`/m/module/biz-approve-customer-sales-req`
> **PC 原路径**：项目监管-审批-客户销售需求
> **功能清单唯一定义来源**：`03-前端原型demo/B端H5/src/data/mobileMenuData.ts`
> **基准路径**：`B端H5/03-业务办理/03-客户需求审批/05-客户销售需求`
