...
> **moduleId**：`ws-cargo-movement`
> **菜单路径**：工作台 → 仓储 → 异动管理
> **原型路由**：`/m/module/ws-cargo-movement`
> **PC 原路径**：货物数量变更
> **功能清单唯一定义来源**：`03-前端原型demo/B端H5/src/data/mobileMenuData.ts`
> **基准路径**：`B端H5/02-工作台/01-仓储/17-异动管理`
> **导航索引**：[00-菜单地图.md](../../../00-菜单地图.md) · [01-功能清单与原型路由.md](../../../01-功能清单与原型路由.md)

> **业务规则（PC 基准）**：[13-货物异动-异动记录](../../../../B端PC/02-仓储/13-货物异动-异动记录/)

---

## 功能说明

管理库区内因损耗、溢短装或取样导致的货物数量变更作业，完整记录审批留痕。
