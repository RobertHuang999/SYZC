...
> **moduleId**：`ws-trade-sales`
> **菜单路径**：工作台 → 交易 → 销售需求管理
> **原型路由**：`/m/module/ws-trade-sales`
> **PC 原路径**：其他～销售需求管理
> **功能清单唯一定义来源**：`03-前端原型demo/B端H5/src/data/mobileMenuData.ts`
> **基准路径**：`B端H5/02-工作台/03-交易/02-销售需求管理`
> **导航索引**：[00-菜单地图.md](../../../00-菜单地图.md) · [01-功能清单与原型路由.md](../../../01-功能清单与原型路由.md)

> **业务规则（PC 基准）**：[02-销售需求管理](../../../../B端PC/04-交易/02-销售需求管理/)

---

## 功能说明

记录及审核产业链销售订单与货主委托需求，辅助核实验证交易履约能力。
