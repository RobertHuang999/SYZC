...
**风险公示**面向 [02押品预警信息](../06-风险信息-押品预警信息/押品预警信息主PRD.md) 中处于“已处理（有效）”的重大押品风险，提供对外信息披露的发布与管理中枢。它建立**原预警与公示记录完全解耦的独立快照机制**，支持单条确认公示、批量快速公示、公示版本管理以及**取消公示（200 字原因核查、多版本操作审计只增不改）**，确保公示信息客观严谨、合规可溯。
