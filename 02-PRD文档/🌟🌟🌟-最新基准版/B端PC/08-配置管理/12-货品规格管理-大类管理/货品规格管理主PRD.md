...
> **编写依据**：[01大类管理字段清单.md](./01大类管理字段清单.md)、[02品类管理字段清单.md](../13-货品规格管理-品类管理/02品类管理字段清单.md)、[03货品管理字段清单.md](../14-货品规格管理-货品管理/03货品管理字段清单.md)
> **字段基准**：[01大类管理字段清单.md](./01大类管理字段清单.md)、[02品类管理字段清单.md](../13-货品规格管理-品类管理/02品类管理字段清单.md)、[03货品管理字段清单.md](../14-货品规格管理-货品管理/03货品管理字段清单.md) 是本模块所有字段、枚举和字段规则的唯一基准。
...
大类和品类列表分别继承 [01大类管理字段清单.md](./01大类管理字段清单.md) 和 [02品类管理字段清单.md](../13-货品规格管理-品类管理/02品类管理字段清单.md)。动态规格参数按品类配置拆列展示；计量参数和单位按 `计量参数(单位)` 展示；入库收集信息展示已配置项摘要。
