...
> **编写依据**：[01大类管理字段清单.md](../12-货品规格管理-大类管理/01大类管理字段清单.md)、[02品类管理字段清单.md](./02品类管理字段清单.md)、[03货品管理字段清单.md](../14-货品规格管理-货品管理/03货品管理字段清单.md)
> **字段基准**：[01大类管理字段清单.md](../12-货品规格管理-大类管理/01大类管理字段清单.md)、[02品类管理字段清单.md](./02品类管理字段清单.md)、[03货品管理字段清单.md](../14-货品规格管理-货品管理/03货品管理字段清单.md) 是本模块所有字段、枚举和字段规则的唯一基准。
...
列表字段定义继承自 [03货品管理字段清单.md](../14-货品规格管理-货品管理/03货品管理字段清单.md)。

> `序号`、`品类`、`[动态规格参数列1..N]`、`计量参数`、`入库收集信息`、`单价`、`状态`、`操作`。

大类和品类列表分别继承 [01大类管理字段清单.md](../12-货品规格管理-大类管理/01大类管理字段清单.md) 和 [02品类管理字段清单.md](./02品类管理字段清单.md)。动态规格参数按品类配置拆列展示；计量参数和单位按 `计量参数(单位)` 展示；入库收集信息展示已配置项摘要。
...
具体输入方式、枚举值、数值精度和日期校验唯一引用 [03货品管理字段清单.md](../14-货品规格管理-货品管理/03货品管理字段清单.md) 的“入库收集信息配置”章节。本期不支持自定义字段名称、输入类型或枚举值。
