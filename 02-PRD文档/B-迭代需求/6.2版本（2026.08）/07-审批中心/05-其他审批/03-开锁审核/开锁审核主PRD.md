...
| 凭证生成/短信下发/撤销 | [03/04/04-开锁审批](../03-业务审批/04-我的申请管理/04-开锁审批/开锁申请主PRD.md) §四 凭证         |
...
子类型额外权限（凭证查看、管理员关闭等）见 [开锁申请业务规则规格](../03-业务审批/04-我的申请管理/04-开锁审批/开锁申请业务规则规格.md)。
