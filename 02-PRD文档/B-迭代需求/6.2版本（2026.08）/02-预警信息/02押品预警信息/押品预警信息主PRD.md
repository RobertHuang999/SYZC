...
flowchart TD
    ...
    subgraph S2[核心控制：流水承接、去重投影与处置流转]
        ...
        LEDGER --> ROUTE{处置路径分流}
        ROUTE -->|商业类: 监管业务率/超时/贷中| JUMP[行操作【解除预警】<br/>引导跳转抵质押单据 COL-R01]
...
| :--- | :--- | :--- | :--- |
| **场景 1【监管业务率超标引导处置】(S01)** | 动态风控盯市引擎 | 质押电解铜市场价格下跌，某笔质押订单实时质押率达 88.50%，突破规则配置的平仓警戒线（85.00%）。系统生成 `待处置 · 有效`、类型「监管业务率异常」预警，风控人员在列表点击【解除预警】，系统引导跳转至该抵质押单据办理追加质押物或追加保证金，单据办结后自动回写预警结案。 | 消除信息断层，实现风险告警向金融业务挽损操作的自动化引导与闭环。 |
