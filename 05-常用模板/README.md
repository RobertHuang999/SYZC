...
- 以“字段来源、取值说明、必填性、页面展示、筛选和详情展示”为统一字段口径
- 可按需覆盖档案、单据和明细等功能形态
- 包含业务字段、明细字段、系统字段和展示引用规则

**使用方式**：按功能形态保留适用章节，删除不适用章节；字段定义完成后再生成主 PRD 和前端 Demo。

---

### 业务流程类模板

#### [b-业务流程推演模板.md](./b-业务流程推演模板.md)
...
#### [e-画原型 : 生成 Demo.md](./e-画原型%20:%20生成%20Demo.md)
...
1. **复制现有模板**作为基础
2. **调整章节**，删除不需要的部分
3. **保存到05-常用模板/**，命名格式：`[用途]-template.md`
