    ...
    details: [
      {
        ...
        items: [
          ...
          },
          {
            ...
            content: "仅在预警状态为已作废时展示，详细说明导致预警作废的原因（如“预警配置阈值调整重算置换（旧阈值 10% 已作废，已生成新预警流水）（C11）”、“关联订单预警配置已删除（C11）”或“订单已正常解质押出库”）。",
          },
        ],
      },
    ],
...
• 列表模板：仓库：{系统仓库路径}；位置：{用户手录位置}；触发内容：{事实摘要}（与 02/01 一致）
• 详情穿透专区：所属仓库、位置、触发设备名称、物理事件子类型；关联设备事件 {事件编号}，请至设备事件台账现场核销`,
          },
        ],
      },
      {
    ...
    details: [
      {
        ...
        items: [
          ...
          {
            label: "所属仓库 / 位置 (triggerLocation + installLocation)",
            content: "所属仓库为系统引用「仓库/库房/分区」拼接；位置为用户手录安装位置。二者均继承 02/01 设备预警快照，用于核验设备部署与在押货物空间重叠关系。",
          },
        ],
      },
      {
    ...
    details: [
      ...
      },
      {
        ...
        items: [
          ...
          {
            label: "快照字段",
            content: "确认页/详情页按「公示信息 + 处置信息」分区展示独立副本字段，不使用合成的「公示标题/公示内容」文本块。",
          },
        ],
      },
    ],
