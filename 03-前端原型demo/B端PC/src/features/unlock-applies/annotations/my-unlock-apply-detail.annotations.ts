...
export const myUnlockApplyDetailAnnotations: PrototypeAnnotation[] = [
  ...
  },
  {
    ...
    content:
      "规则来源：业务规则规格 §4.1 / §4.4、02查看与下发凭证 §三。密码服务成功→已下发；失败→生成失败。「下发失败」仅人脸（26010），挂锁无此概念。",
    details: [
      {
        title: "详情区",
        items: [
          {
            label: "挂锁 · 已下发/生成失败",
            content: "27020 等：密码+复制。26008：GEN_FAILED=密码服务失败，可重新获取。挂锁无「下发失败」。",
          },
          {
            label: "人脸 · 三方下发失败",
            content: "26010：remark 标注三方终端失败；凭证仍=已下发，详情有密码。",
          },
        ],
      },
    ],
