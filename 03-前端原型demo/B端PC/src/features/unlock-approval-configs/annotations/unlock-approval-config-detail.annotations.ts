...
export const unlockApprovalConfigDetailAnnotations: PrototypeAnnotation[] = [
  ...
  },
  {
    ...
    title: "基础信息与适用设备清单",
    content:
      "只读展示配置业务编号、配置名称及适用设备范围；点击【查看设备清单】弹出与设备预警配置一致的已关联设备清单弹窗。",
    details: [
      {
        title: "字段与交互规范",
        items: [
          {
            label: "配置编号",
            content: "系统自动生成的业务唯一主键（如「UNLOCK-CFG-001」），递增版本时沿用同一编号。",
          },
          {
            label: "配置名称",
          ...
          },
          {
            label: "已关联设备清单弹窗",
            content:
              "对齐设备预警配置交互规范：展示总计/在线/离线数量徽标，支持关键字快速过滤、设备类型（挂锁/人脸）与状态筛选，表格展示序号、设备编号（支持一键复制）、设备名称、设备类型徽章、所属仓库、安装货位与在线/离线状态指示灯。",
          },
        ],
      },
    ],
