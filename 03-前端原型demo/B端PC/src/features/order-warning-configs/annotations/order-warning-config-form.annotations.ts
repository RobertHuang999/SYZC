    ...
    details: [
      {
        ...
        items: [
          ...
          {
            label: "贷中风控模型 · 经典双栏布局 (ORD-R20)",
            content: "策略 6 卡片单选风控模型（如仓单尽调产品-版本1）；选定后展现经典双栏布局：左栏为【输入项】（个人姓名/电话/身份证、企业名称/电话/信用代码自选或自动匹配订单主体），右栏为【输出项】（产品评分与额度的区间/单目运算符比较、结果状态单选）；满足任一越限即触发押品高危告警，并异步联动贷中台账。",
          },
        ],
      },
    ],
