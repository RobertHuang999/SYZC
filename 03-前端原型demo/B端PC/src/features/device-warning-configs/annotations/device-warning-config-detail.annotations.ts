...
• 全局监听模式提示：若 newDeviceOnly=true，弹窗展示全局监听基线提示卡片，无需指定具体存量设备清单。`,
  ...
  },
  {
    ...
    kind: "规则",
    title: "通知渠道与超时升级策略",
    content: "展示命中时触达的外部通知渠道、预警接收人，以及超时未处置时的升级天数与升级接收人；移动端「设备预警信息」待处置红点无需配置。",
    details: [
      {
        title: "升级通知机制",
        items: [
          {
            label: "通知渠道",
            content: "支持短信、邮件多选组合推送；预警命中时移动端「设备预警信息」入口自动展示待处置红点；未配置通知对象或未勾选渠道时不下发外部通知。",
          },
          {
            label: "超时升级梯队",
            content: "配置超时 T 天未解除时，仅通过短信向升级对象逐级上报督办；不受首次通知邮件渠道影响。处置策略为「触发即结案」时升级区隐藏（R15a）。升级计时以每条流水的预警时间为起点。",
          },
        ],
      },
    ],
