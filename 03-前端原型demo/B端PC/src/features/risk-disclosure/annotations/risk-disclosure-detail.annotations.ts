...
export const riskDisclosureDetailAnnotations: PrototypeAnnotation[] = [
  ...
  },
  {
    ...
    kind: "交互",
    title: "取消公示弹窗与校验规则",
    content: "列表不提供取消入口。已公示详情顶栏展示【重新公示】【取消公示】【返回】；取消公示弹出二次确认，强制录入 1～200 字取消说明。",
    details: [
      {
        title: "交互与校验约束",
        items: [
          {
            label: "入口",
            content: "仅详情页已公示状态展示【取消公示】；列表行操作只有【详情】。",
          },
          {
            label: "取消理由必填",
            content: "多行文本输入框，1～200 字，禁止全空格；理由为空时【确认取消】按钮保持禁用。仅 R-RISK-MGR 可操作。",
          },
          {
            label: "操作反馈",
            content: "提交成功后该记录从已公示列表消失，详情状态流转为【已取消】，全路径审计留痕并 Toast 提示。",
          },
        ],
      },
    ],
