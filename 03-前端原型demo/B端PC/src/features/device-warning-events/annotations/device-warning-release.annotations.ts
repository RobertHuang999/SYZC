...
export const deviceWarningReleaseAnnotations: PrototypeAnnotation[] = [
  {
    ...
    F --> G["取消该条升级定时任务"]`,
          ...
          {
            label: "业务意义",
            content: "人工解除必须具备明确的处置事实与留痕照片，保障监管合规；解除提交仅归档本条独立流水，不涉及频次聚合或整轮归档。",
          },
        ],
      },
      {
  ...
  },
  {
    ...
    kind: "字段",
    title: "告警事实核验摘要",
    content: "展示待解除单条事件的核心事实快照，明确处置对象。",
    details: [
      {
        title: "关键核验字段",
        items: [
          ...
          {
            label: "预警时间",
            content: "本条独立流水的触发时间 warningTime，作为升级计时起点展示。",
          },
          {
            label: "预警抓拍凭证",
    ...
    details: [
      {
        ...
        items: [
          ...
          {
            label: "升级任务取消",
            content: "解除成功后，服务端立即取消该条流水挂起的未执行升级通知（如 2小时未处理短信通知）。",
          },
          {
            label: "全路径审计留痕",
