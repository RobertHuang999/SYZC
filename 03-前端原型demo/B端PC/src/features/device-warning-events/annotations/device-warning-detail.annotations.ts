    ...
    details: [
      {
        ...
        items: [
          ...
          },
          {
            ...
            content: "位于预警内容下方；设备厂商在告警触发时自动回传，可能有多张，支持缩略图与轮播预览。与监控主动抓拍及核销人工上传照片区分。",
          },
          {
            label: "预警抓拍图",
            content: "系统产生预警时主动调用同库区摄像头抓拍的监控画面；图片存储于私有对象存储，前端通过服务端换取 15 分钟时效签名 URL 查看；受 P05 图片查看权限控制。",
          },
        ],
      },
    ],
