...
const rawDeviceWarningEventUseCases: RawDeviceWarningEvent[] = [
  {
    ...
    ...USECASE_SEVERITY.L4,
    warningType: "设备物联预警",
    warehouseDetail: systemWarehousePath(USECASE_WAREHOUSES.WH_A, "A库", "01分区"),
    location: "H01货架东侧",
    deviceName: "温湿度TH01",
  ...
  },
  {
    ...
    triggerSummary: "二氧化碳浓度超标 1800 ppm / 阈值 400~1500 ppm",
    snapshotImageStatus: "available",
  ...
  },
  {
    ...
    warehouseDetail: systemWarehousePath(USECASE_WAREHOUSES.WH_A, "B库", "监控区"),
    location: "B库西侧通道",
    deviceName: "CAM1",
    triggerSummary: "行人入侵",
    snapshotImageStatus: "available",
  ...
  },
  {
    ...
    ...USECASE_SEVERITY.L2,
    warningType: "智能挂锁预警",
    warehouseDetail: systemWarehousePath(USECASE_WAREHOUSES.WH_B, "1号门", "装卸区"),
    location: "1号门南侧装卸平台",
    deviceName: "LK02",
    triggerSummary: "开锁通知",
    snapshotImageStatus: "available",
  ...
  },
  {
    ...
    ...USECASE_SEVERITY.L3,
    warningType: "设备物联预警",
    warehouseDetail: systemWarehousePath(USECASE_WAREHOUSES.WH_C, "监测区", "2号货架"),
    location: "2号货架顶层",
    deviceName: "O2传感器",
    triggerSummary: "设备离线",
  ...
  },
  {
    ...
    ...USECASE_SEVERITY.L2,
    warningType: "人脸门禁预警",
    warehouseDetail: systemWarehousePath(USECASE_WAREHOUSES.WH_A, "主入口", "门禁区"),
    location: "主入口闸机前3米",
    deviceName: "FACE1",
    triggerSummary: "开锁通知",
    snapshotImageStatus: "available",
  ...
  },
  {
    ...
    ...USECASE_SEVERITY.L4,
    warningType: "设备物联预警",
    warehouseDetail: systemWarehousePath(USECASE_WAREHOUSES.WH_B, "C库", "03分区"),
    location: "C库通风口附近",
    deviceName: "温湿度TH08",
  ...
  },
  {
    ...
    ...USECASE_SEVERITY.L3,
    warningType: "设备物联预警",
    warehouseDetail: systemWarehousePath(USECASE_WAREHOUSES.WH_D, "D库", "危化区"),
    location: "D库东区消防通道",
    deviceName: "烟感YG03",
    triggerSummary: "烟感异常",
  ...
  },
  {
    ...
    ...USECASE_SEVERITY.L3,
    warningType: "设备GPS预警",
    warehouseDetail: systemWarehousePath(USECASE_WAREHOUSES.WH_E, "运输线", "途中"),
    location: "沪G·12345 车载终端",
    deviceName: "GPS-T001",
    triggerSummary: "设备离线",
    snapshotImageStatus: "none",
  ...
  },
  {
    ...
    ...USECASE_SEVERITY.L4,
    warningType: "人脸门禁预警",
    warehouseDetail: systemWarehousePath(USECASE_WAREHOUSES.WH_C, "2号门", "冷藏区"),
    location: "2号门内通道",
    deviceName: "DOOR-A2",
  ...
  },
  {
    ...
    ...USECASE_SEVERITY.L5,
    warningType: "智能挂锁预警",
    warehouseDetail: systemWarehousePath(USECASE_WAREHOUSES.WH_D, "东门", "仓储区"),
    location: "东门右侧挂锁位",
    deviceName: "LK15",
    triggerSummary: "拆壳",
    snapshotImageStatus: "available",
  ...
  },
  {
    ...
    ...USECASE_SEVERITY.L5,
    warningType: "智能挂锁预警",
    warehouseDetail: systemWarehousePath(USECASE_WAREHOUSES.WH_B, "3号门", "散粮区"),
    location: "3号门货运通道",
    deviceName: "LK09",
    triggerSummary: "非法开箱",
    snapshotImageStatus: "available",
  ...
  },
  {
    ...
    ...USECASE_SEVERITY.L3,
    warningType: "智能挂锁预警",
    warehouseDetail: systemWarehousePath(USECASE_WAREHOUSES.WH_E, "侧门", "高安保区"),
    location: "侧门双岗值守点",
    deviceName: "LK21",
    triggerSummary: "开锁通知",
    snapshotImageStatus: "available",
  ...
  },
  {
    ...
    ...USECASE_SEVERITY.L4,
    warningType: "设备GPS预警",
    warehouseDetail: systemWarehousePath(USECASE_WAREHOUSES.WH_E, "运输线", "围栏外"),
    location: "运输线围栏外500m",
    deviceName: "GPS-T002",
  ...
  },
  {
    ...
    ...USECASE_SEVERITY.L5,
    warningType: "智能挂锁预警",
    warehouseDetail: systemWarehousePath(USECASE_WAREHOUSES.WH_C, "1号门", "冷藏区"),
    location: "1号门内侧保温门",
    deviceName: "LK06",
    triggerSummary: "锁舌被卡",
    snapshotImageStatus: "failed",
  ...
  },
  {
    ...
    ...USECASE_SEVERITY.L5,
    warningType: "智能挂锁预警",
    warehouseDetail: systemWarehousePath(USECASE_WAREHOUSES.WH_A, "西门", "出货区"),
    location: "西门挂锁位LK-11",
    deviceName: "LK11",
    triggerSummary: "锁杆被剪",
    snapshotImageStatus: "available",
  ...
  },
  {
    ...
    ...USECASE_SEVERITY.L2,
    warningType: "智能挂锁预警",
    warehouseDetail: systemWarehousePath(USECASE_WAREHOUSES.WH_B, "2号门", "散粮区"),
    location: "2号门货台",
    deviceName: "LK18",
    triggerSummary: "关锁通知",
    snapshotImageStatus: "available",
