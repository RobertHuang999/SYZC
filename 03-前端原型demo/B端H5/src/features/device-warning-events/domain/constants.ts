...
export const DEVICE_WARNING_SUB_TYPES: Record<string, string[]> = {
  设备图像识别预警: ["行人入侵", "车辆入侵", "物品形态变化", "设备离线", "设备上线", "设备移除"],
  设备物联预警: ["温度异常", "湿度异常", "烟感异常", "二氧化碳异常", "氧气异常", "设备离线", "设备上线", "设备移除"],
  智能挂锁预警: ["拆壳", "锁舌被卡", "锁杆被剪", "非法开箱", "拆卡报警", "密码错误", "关锁异常", "电量低于20%", "开锁通知", "关锁通知", "设备上线", "设备移除"],
  人脸门禁预警: ["门未关", "密码错误", "设备离线", "开锁通知", "关锁通知", "设备上线", "设备移除"],
  设备GPS预警: ["进围栏", "出围栏", "普通限速", "怠速滞留", "路线偏离", "非法拆除", "设备离线", "设备上线", "设备移除"],
  常规通行与操作事务: [
    "获取密码成功",
    "获取密码失败",
    "密码认证成功",
