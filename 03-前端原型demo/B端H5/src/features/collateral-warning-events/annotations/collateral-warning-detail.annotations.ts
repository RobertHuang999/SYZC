    ...
    details: [
      {
        ...
        items: [
          ...
          },
          {
            ...
            content: "6.2 当前收敛的 7 大预警类型之一（解抵/质押超时、价格下跌、盘点异常、巡检异常、监管业务率异常、贷中风控预警、物联穿透告警）；不再展示旧复合类型“解抵/质押/监管超时”。",
          },
          {
            label: "预警等级",
          ...
          },
          {
            ...
            content: "未公示、已公示、已取消；已结案记录支持发起公示风险。",
          },
          {
...
2. 监管业务率异常：监控指标随订单类型（抵押率/质押率/监管业务率）/ 平仓线 (85%) / 补仓线 (75%)
